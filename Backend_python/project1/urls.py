...
urlpatterns = [
    ...
    path('api/check_user/', views.check_user_exists, name='check_user'),
    path('api/validate_new_user/', views.validate_signup_info, name='validate_info'),
    path('api/all_posts/', views.all_posts, name='all_posts'),
    path('api/view_all_posts/', PostInfoView.as_view(), name='post-info'),   
    ...
    path('api/user_profile/<str:username>/', views.user_profile, name='user_profile'),
    path('api/follow_toggle/', views.follow_toggle, name='follow_toggle'),
